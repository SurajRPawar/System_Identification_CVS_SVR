%% A and Rv estimation using UKF and Two Element Windkessel model
%{
---------------------------- Description ----------------------------------
...
v6 : Suraj R Pawar, 6-12-2020
    - Qa filtered signal and thresholds added as a structure. 
    - Structure is passed to the UKF function
%}
...
%% Figures
    figure;   
    ax = [];
    Vbarplot = subplot(3,2,1);
    Plvplot = subplot(3,2,2);
    Psplot = subplot(3,2,3);
    Aplot = subplot(3,2,4);
    Rvplot = subplot(3,2,5);
